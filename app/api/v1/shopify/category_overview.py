...
async def category_overview(
    ...
    sort_by: Optional[str] = Query("sales", description="排序方式: sales/volume/salesChange/volumeChange/blueOceanIndex"),
    color_mode: Optional[str] = Query("red-up", description="颜色模式: red-up/red-down"),
):
    """
    品类大盘 Treemap 数据接口
