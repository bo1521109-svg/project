...
const categories = [
  ...
  { label: '美妆个护', value: 'beauty', children: [
  ...
  { label: '女装与女士内衣', value: 'women-fashion', children: [
  ...
  { label: '保健', value: 'health', children: [
  ...
  { label: '时尚配件', value: 'fashion-accessories', children: [
  ...
  { label: '运动与户外', value: 'sports', children: [
  ...
  { label: '手机与数码', value: 'electronics', children: [
  ...
  { label: '居家日用', value: 'home', children: [
  ...
  { label: '食品饮料', value: 'food', children: [
  ...
  { label: '汽车与摩托车', value: 'automotive', children: [
  ...
  { label: '男装与男士内衣', value: 'men-fashion', children: [
  ...
  { label: '收藏品', value: 'collectibles', children: [
  ...
  { label: '玩具和爱好', value: 'toys', children: [
  ...
  { label: '厨房用品', value: 'kitchen', children: [
  ...
  { label: '家装建材', value: 'home-improvement', children: [
  ...
  { label: '电脑办公', value: 'office', children: [
  ...
  { label: '珠宝与仿生首饰', value: 'jewelry', children: [
  ...
  { label: '图书杂志音像', value: 'books', children: [
  ...
  { label: '母婴用品', value: 'baby', children: [
  ...
  { label: '家具', value: 'furniture', children: [
  ...
  { label: '儿童时尚', value: 'kids-fashion', children: [
  ...
  { label: '穆斯林时尚', value: 'muslim-fashion', children: [
  ...
  { label: '二手', value: 'second-hand', children: [
  ...
  { label: '虚拟商品', value: 'virtual', children: [
    { label: '电信', value: 'virtual-telecom' }
  ]},
  { label: 'POD定制', value: 'pod-custom', children: [] },
  { label: '成人用品', value: 'adult-products', children: [] },
  { label: '文化', value: 'culture', children: [] }
]
...
const fetchStores = async () => {
  ...
  try {
    ...
    // 添加近7天销量筛选
    if (filters.value.sales7d && filters.value.sales7d !== 'all') {
      const option = sales7dOptions.find(opt => opt.value === filters.value.sales7d)
      if (option) {
    ...
    // 添加总销量筛选
    if (filters.value.totalSales && filters.value.totalSales !== 'all') {
      const option = totalSalesOptions.find(opt => opt.value === filters.value.totalSales)
      if (option) {
...
const getCountryLabel = (code) => {
  // 优先使用 country_code，如果没有则尝试 country 字段
