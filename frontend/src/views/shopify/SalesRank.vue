    ...
    <el-card>
      ...
      <div class="table-container">
        <el-table :data="rankingData" style="width: 100%" v-loading="loading">
          ...
          <el-table-column prop="sales_7d" label="近7天销量" width="120" sortable />
...
const fetchRanking = async () => {
  ...
  try {
    ...
    const response = await request.get('/v1/shopify/products/sales-rank', { params })
    ...
    ElMessage.error('获取销量榜失败：' + (error.response?.data?.detail || error.message))
  } finally {
    loading.value = false
  }
}
