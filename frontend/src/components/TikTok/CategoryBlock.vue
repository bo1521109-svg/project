...
<script setup>
/*
 * TikTok品类大盘每个大类的Treemap子组件
 * 从Shopify CategoryBlock复制，导航跳转改为TikTok商品搜索页
 */
...
const onMouseEnter = (e) => { emit('card-enter', e) }
const onMouseLeave = () => { emit('card-leave') }
